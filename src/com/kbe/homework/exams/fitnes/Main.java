...
public class Main {
    public static void main(String[] args) {
        Client ivan = new Client("Иван","Иванов",InfoMesage.GROUP);
        Client oleg = new Client("Олег","Сидоров",InfoMesage.GROUP);
        Client alex = new Client("Александр","Петров",InfoMesage.GYM);
